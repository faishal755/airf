...
function ListingPage1() {
  ...
  relative overflow-auto"
    >
      <form
        action=""
        className="max-w-[900px] w-[90%] h-[550px] flex items-center mt-[150px]
          justify-start  flex-col md:items-start gap-[10px] overflow-auto"
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        ...
        <button className="px-[50px] py-[10px] bg-[#a03535] text-[white] text-[18px] md:px-[100px] rounded-lg">
          Next
        </button>
      </form>
    </div>
